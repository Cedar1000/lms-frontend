...
const UpcomingClasses = () => {
  ...
  return (
    <div className="">
      ...
      <p className="text-xs mt-3 text-lightpink">
        Your classes have been scheduled for these times, do well to attend to{' '}
        <br /> them
      </p>
      ...
      {lectureassignment.map((lecture, index) => (
        <div
          key={index}
          className="flex gap-2 items-start my-6 bg-shadedblue p-1"
        >
