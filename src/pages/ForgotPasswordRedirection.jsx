  ...
  return (
    <Layout className="w-full md:w-[100%] bg-primary_blue">
      <div className="min-h-screen">
        <form
          action=""
          className="flex justify-center items-center outline-none md:min-h-screen"
        >
          <div className="space-y-12">
            ...
            <div className="flex gap-5 items-center w-full md:w-[30rem]">
              ...
              <input
                ...
                className="w-full bg-transparent border-2 border-solid border-white p-3 rounded-2xl outline-none"
              />
            </div>
